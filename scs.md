...
+ Контейнер `Spring` является основным компонентом фреймворка и отвечает за создание, настройку и управление бинами. Когда бин создается в контейнере 
